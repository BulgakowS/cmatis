...
<form action="<?php echo url_for('@edit_about'); ?>" method="POST" name="<?php echo $form->getName() ?>">
    ...
    <div class="row-fluid">
        ...
        <div class="row">
            <div class="form_row <?php if ($form['ru']['description_on_main']->rendererror()) echo 'control-group error' ?>">
                <div class="form_label">
                    <?php echo $form['ru']['description_on_main']->renderLabel(); ?>
                </div>
                <?php if ($form['ru']['description_on_main']->rendererror()): ?>
                    <div class="alert alert-error"><?php echo $form['ru']['description_on_main']->rendererror(); ?></div>
                <?php endif; ?>
                <div class="form_edit">
                    <?php echo $form['ru']['description_on_main']->render(array('style'=>'width:83%;', 'class'=>'editor')); ?>
                </div>
            </div>
        </div>
    </div>
    <div class="row-fluid">
        ...
        <div class="row">
            <div class="form_row <?php if ($form['uk']['description_on_main']->rendererror()) echo 'control-group error' ?>">
                <div class="form_label">
                    <?php echo $form['uk']['description_on_main']->renderLabel(); ?>
                </div>
                <?php if ($form['uk']['description_on_main']->rendererror()): ?>
                    <div class="alert alert-error"><?php echo $form['uk']['description_on_main']->rendererror(); ?></div>
                <?php endif; ?>
                <div class="form_edit">
                    <?php echo $form['uk']['description_on_main']->render(array('style'=>'width:83%;', 'class'=>'editor')); ?>
                </div>
            </div>
        </div>
    </div>
    <div class="row-fluid">
        ...
        <div class="row">
            <div class="form_row <?php if ($form['en']['description_on_main']->rendererror()) echo 'control-group error' ?>">
                <div class="form_label">
                    <?php echo $form['en']['description_on_main']->renderLabel(); ?>
                </div>
                <?php if ($form['en']['description_on_main']->rendererror()): ?>
                    <div class="alert alert-error"><?php echo $form['en']['description_on_main']->rendererror(); ?></div>
                <?php endif; ?>
                <div class="form_edit">
                    <?php echo $form['en']['description_on_main']->render(array('style'=>'width:83%;', 'class'=>'editor')); ?>
                </div>
            </div>
        </div>
    </div>
